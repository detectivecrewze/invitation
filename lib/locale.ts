...
const PAIRS: [string, string][] = [
  ...
  ["Format Aktif", "Active Format"], ["Ubah Format ⚙️", "Change Format ⚙️"], ["Ubah ⚙️", "Change ⚙️"], ["Ubah Format", "Change Format"], ["Ubah", "Change"],
  ...
  ["Format Undangan Kencan ✨", "Date Invitation Format ✨"], ["Format Undangan Kencan", "Date Invitation Format"], ["Pilih format terbaik untuk momen kalian", "Choose the best format for your moment"],
  ["Format: Invitation ⚙️", "Format: Invitation ⚙️"], ["Format: Rundown ⚙️", "Format: Rundown ⚙️"], ["Format: Invitation", "Format: Invitation"], ["Format: Rundown", "Format: Rundown"],
  ["Ubah ke Invitation Date 💌", "Switch to Invitation Date"], ["Ubah ke Invitation Date", "Switch to Invitation Date"],
  ["Ubah ke Rundown Date ⏱️", "Switch to Rundown Date"], ["Ubah ke Rundown Date", "Switch to Rundown Date"],
  ["Mengubah Format...", "Changing format..."],
  ["Interactive Date Invitation", "Interactive Date Invitation"],
  ["Ada animasi amplop & bunga pembuka.", "Opening envelope & blooming flower animation."],
  ["Pasangan memilih dari opsi tanggal & kegiatan.", "Partner picks from date & activity choices."],
  ["Menghasilkan Tiket Kencan sesuai pilihan pasangan.", "Generates a Date Ticket tailored to their picks."],
  ["Linimasa itinerary waktu & lokasi (09:00, 12:00, 15:00).", "Time & location itinerary timeline (09:00, 12:00, 15:00)."],
  ["Dilengkapi QR Barcode Tiket Masuk Kencan.", "Includes QR Barcode Date Pass Ticket."],
  ["Cocok untuk Anniversary / Trip Seharian.", "Perfect for Anniversaries & Full-Day Trips."],
  ...
  ["Nama yang akan muncul di undangan", "The name shown on the invitation"], ["Intip Tampilan", "Preview Position"], ["Intip", "Preview"],
  ...
  ["Pilih Latar Musik", "Choose Background Music"], ["— ATAU PILIH DARI PRESET —", "— OR CHOOSE A PRESET —"],
  ["Upload lagu MP3", "Upload an MP3"], ["Mengunggah lagu...", "Uploading song..."],
  ["File MP3 dari perangkatmu, maksimal 25 MB", "MP3 from your device, up to 25 MB"],
  ["File dari perangkatmu, maksimal 25 MB", "A file from your device, up to 25 MB"],
  ["Upload MP3 atau pilih lagu dari library", "Upload an MP3 or choose a song from the library"],
  ["Pilih file MP3.", "Choose an MP3 file."], ["Ukuran MP3 maksimal 25 MB.", "MP3 files can be up to 25 MB."],
  ["Lagu berhasil diunggah!", "Song uploaded!"], ["Upload lagu gagal. Coba lagi.", "Song upload failed. Please try again."],
  ...
  ["Latar Musik Undangan", "Invitation Background Music"],
  ...
  ["AKSES VIP", "VIP ACCESS"], ["VIP Pass: A Day Out", "VIP Pass: A Day Out"], ["VIP Pass: A Day Out", "A Day Out VIP Pass"],
  ["Personal Day Out Itinerary", "Personal Day Out Itinerary"],
