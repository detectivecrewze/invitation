...
export const IconChevronDown = ({ size = 24, color = "currentColor", strokeWidth = 1.5 }: IconProps) => (
  <svg {...d(size, color, strokeWidth)}>
    <polyline points="6 9 12 15 18 9" />
  </svg>
);

export const IconChevronUp = ({ size = 24, color = "currentColor", strokeWidth = 1.5 }: IconProps) => (
  <svg {...d(size, color, strokeWidth)}>
...
export const IconClipboard = ({ size = 24, color = "currentColor", strokeWidth = 1.5 }: IconProps) => (
  <svg {...d(size, color, strokeWidth)}>
